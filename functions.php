...
function youku_video($atts, $content=null){
	return '<p style="text-align: center;"><embed src=http://static.youku.com/v1.0.0223/v/swf/loader.swf?VideoIDS='.$content.'ID&winType=adshow quality="high" width="610" height="460" align="middle" wmode="transparent" allowfullscreen="true" allowScriptAccess="never" allowNetworking="internal" autostart="0" type="application/x-shockwave-flash"></embed></p>';
}
