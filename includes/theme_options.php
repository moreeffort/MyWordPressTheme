...
<h2><?php echo $themename; ?>主题选项<a href='http://me.alipay.com/zmingcx' target="_blank"><img src="<?php bloginfo('template_directory')?>/includes/options/alipay.png" /></a></h2>
<p>当前主题: HotNewspro 2.7.3 Plus版 | 设计者：<a href="http://zmingcx.com" target="_blank">知更鸟</a> | <a href="http://zmingcx.com/hotnews-pro-theme-27.html" target="_blank">查看更新</a> | <a href="http://zmingcx.com/hotnews-pro-plus-faq.html" target="_blank">常见问题</a></p>
<div class="rm_opts">
<form method="post">
