...
<script type="text/javascript">
DD_belatedPNG.fix('.boxCaption,.top_box,.logo,.reply,.imgcat,#fancybox-left-ico,#fancybox-right-ico,#fancybox-close');
</script>
<![endif]-->
<!-- 图片延迟加载 -->
...
<div id="wrapper">
	...
	<?php if (get_option('swt_hot') == '关闭') { ?>
		...
		<!-- end:header_image -->
	<?php } else { include(TEMPLATEPATH . '/includes/top_img.php'); } ?>
	<!-- scroll -->
